...
@section('container')
    ...
    <div class="col-lg-8">
        ...
        {{-- <div class="form-floating mb-3">
            <input type="text" name="link" class="form-control @error('link') is-invalid @enderror" id="link" autofocus value="{{ old('link') }}">
        ...
        <button class="btn btn-primary w-100 py-2" type="submit">Buat Postingan</button>
    </form>
    </div>
